...
- [ Introduction ](#intro)
  ...
  - [ Matrix Sparsity ](#usage)
- [ How Recommender Systems Work ](#usage)
- [ Implementations of Recommender Systems ](#usage)
- [ How Amazon’s Recommender System Works ](#usage)
- [ My Implementation ](#usage)
  - [ Limitations of the data ](#usage)
  - [ Matrix Sparsity ](#usage)
  - [ Reducing Sparsity of the data ](#usage)
  - [ My Implementation ](#usage)
- [ Implementing the machine learning algorithm ](#usage)
  - [ Pearson's correlation ](#usage)
